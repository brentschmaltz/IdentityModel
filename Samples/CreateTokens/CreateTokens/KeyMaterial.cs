...
namespace CreateTokens
{
    static public class KeyMaterial
    {
        ...
        static KeyMaterial()
        {
            ...
            SymmetricKeyEncoded_256 = "VbbbbmlbGJw8XH+ZoYBnUHmHga8/o/IduvU/Tht70iE=";
            SymmetricKeyBytes_256 = Convert.FromBase64String(SymmetricKeyEncoded_256);
            SymmetricSecurityKey_256 = new SymmetricSecurityKey(SymmetricKeyBytes_256);
        }
    }
}
